...
class TesterPage extends Component {
    constructor(){
        ...
        this.state = {
            questions: [
                {question: "ท่านมีอาการอย่างน้อย 2 อาการดังต่อไปนี้ ไข้, ไอ, มีน้ำมูก/คัดจมูก เจ็บคอ มีเสมหะ, ถ่ายเหลว, ปวดกล้ามเนื้อ, ปวดศรีษะ", result: -1},
                {question: "ท่านมีประวัติสัมผัสกับผู้ป่วยยืนยัน โรคติดเชื้อ COVID-19 ภายใน 10 วันที่ผ่านมา", result: -1},
                {question: "ในสถานที่ท่านไปประจำ คนที่สนิทใกล้ชิดกับท่าน มีอาการไข้ ไอ น้ำมูก เสมหะมากกว่า 5 คน พร้อมๆ กันภายใน 1 สัปดาห์ที่ผ่านมา", result: -1},
                ...
                {question: "ท่านมีผลยืนยันการตรวจ ATK ด้วยตนเองเป็นบวกภายใน 24-48 ชั่วโมงที่ผ่านมา", result: -1},
                {question: "ท่านเคยมีประวัติติดเชื้อ COVID-19 ภายใน 10 วันที่ผ่านมา", result: -1},
